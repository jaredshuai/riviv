...
mod tests {
    ...
    fn every_written_key_reads_back() {
        ...
        // 60 int keys + one *_keys line per command (55, with #22's two
        // Everything searches, #37's 22 slideshow rows and #38's 14
        // animation commands).
        assert_eq!(c.to_pairs(false).len(), 115, "the upstream save table");
    }
